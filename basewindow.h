...
public:
    ...
    void SubmitUrl(QString ytID); //Add file to download list and create widget
    QMenuBar *WindowMenu;
    QMenu *MainMenu;
    QAction *InputUrl;
...
private:
    ...
    void createNewData(QString ID); //Create new data label and data widget for submitted video
